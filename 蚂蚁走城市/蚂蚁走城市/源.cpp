#pragma once
//【题目名称】	基于安卓的景区智能导游服务系统设计与实现
//本系统以路线规划和拥堵预警为主要研究内容，基于安卓设备的便携性，
//设计并实现景区智能导游服务系统，为景区内游客实时定制游览路线提供可能，
//为景区因游客分布不均产生的拥堵问题提供解决方法。
//要求：
//1、  从实际应用和游客自由定制路线的角度出发，将景区游览路线规划重新定义为连通图部分点遍历问题。
//   针对该问题，设计并实现智能路线规划算法。
//2、  在拥堵预警服务方面，对景点拥堵原因进行分析，采用合适的预测算法，通过对景区内游客提供拥堵预警服务，
//   从而避免因游客分布不均而导致景点拥堵的问题.
//3、  通过对安卓、Java Web开发的学习，对景区智能导游服务系统做出详细设计，编写客户端与服务器端的主要代码，
//   实现该系统。
#include <iostream>  
#include <math.h>  
#include <time.h>  
